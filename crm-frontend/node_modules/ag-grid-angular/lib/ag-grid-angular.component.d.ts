...
export declare class AgGridAngular<TData = any, TColDef extends ColDef<TData> = ColDef<any>> implements AfterViewInit, OnChanges, OnDestroy {
     ...
     */
    rowResizeEnded: EventEmitter<RowResizeEndedEvent>;
